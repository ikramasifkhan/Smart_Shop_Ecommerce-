    ...
    <div class="container">
        <div class="col-md-4 products-left">
            <div class="filter-price">
                ...
                <script type="text/javascript" src="assets/front_end/js/jquery-ui.js"></script>
                <!---->
            </div>
        ...
        <div class="col-md-8 products-right">
            ...
            <div class="men-wear-top">
                ...
                <div  id="top" class="callbacks_container">
                    <ul class="rslides" id="slider3">
                        <li>
                            <img class="img-responsive" src="assets/front_end/images/men1.jpg" alt=" "/>
                        </li>
                        <li>
                            <img class="img-responsive" src="assets/front_end/images/men2.jpg" alt=" "/>
                        </li>
                        <li>
                            <img class="img-responsive" src="assets/front_end/images/men1.jpg" alt=" "/>
                        </li>
            ...
            <div class="men-wear-bottom">
                <div class="col-sm-4 men-wear-left">
                    <img class="img-responsive" src="assets/front_end/images/men3.jpg" alt=" " />
                </div>
            ...
            <div class="col-md-4 product-men no-pad-men">
                <div class="men-pro-item simpleCart_shelfItem">
                    <div class="men-thumb-item">
                        <img src="assets/front_end/images/ep2.png" alt="" class="pro-image-front">
                        <img src="assets/front_end/images/ep2.png" alt="" class="pro-image-back">
                    ...
                    <div class="item-info-product ">
                        <h4><a href="product_details.php">Watches</a></h4>
        ...
        <div class="single-pro">
            ...
            <div class="col-md-3 product-men">
                <div class="men-pro-item simpleCart_shelfItem">
                    <div class="men-thumb-item">
                        <img src="assets/front_end/images/a8.png" alt="" class="pro-image-front">
                        <img src="assets/front_end/images/a8.png" alt="" class="pro-image-back">
                        <div class="men-cart-pro">
                            <div class="inner-men-cart-pro">
                                <a href="product_details.php" class="link-product-add-cart">Quick View</a>
                            </div>
                    ...
                    <div class="item-info-product ">
                        <h4><a href="product_details.php">Blazers</a></h4>
                        <div class="info-product-price">
                            <span class="item_price">$45.99</span>
                            <del>$69.71</del>
                        </div>
