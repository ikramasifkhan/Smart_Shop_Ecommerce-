        ...
        <div class="col-md-6 single-right-left animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
            <div class="grid images_3_of_2">
                <div class="flexslider">
                    ...
                    <!-- //FlexSlider-->
                    <ul class="slides">
                        <li data-thumb="assets/front_end/images/d2.jpg">
                            <div class="thumb-image"> <img src="assets/front_end/images/d2.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="assets/front_end/images/d1.jpg">
                            <div class="thumb-image"> <img src="assets/front_end/images/d1.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>	
                        <li data-thumb="assets/front_end/images/d3.jpg">
                            <div class="thumb-image"> <img src="assets/front_end/images/d3.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="assets/front_end/images/d4.jpg">
                            <div class="thumb-image"> <img src="assets/front_end/images/d4.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>	
                    </ul>
                        ...
                        <div class="bootstrap-tab-text-grids">
                            <div class="bootstrap-tab-text-grid">
                                <div class="bootstrap-tab-text-grid-left">
                                    <img src="assets/front_end/images/men3.jpg" alt=" " class="img-responsive">
                                </div>
