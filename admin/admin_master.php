...
if(isset($_GET['status'])){
   if($_GET['status']=='logout'){
       require '../clases/super_admin.php';
       $super_admin_obj=new Super_admin();
       $super_admin_obj->logout();
   } 
}
?>
<!DOCTYPE html>
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="admin_master.php"><span><?php echo $_SESSION['admin_name'];?></span></a>
                        ...
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a class="submenu" href="show_category.php"><i class="icon-file-alt"></i><span class="hidden-tablet">Show category</span></a></li>
